...
if(!empty($_POST['email'])){
  ...
  if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
    $select = mysqli_query($link, "SELECT * FROM enseignant WHERE email = '".$_POST['email']."' ");
    ...
    $url = 'http://'.$_SERVER['SERVER_NAME'].'/prof/make_new_password.php?id='.$iddata.'&email='.$emaildata;
