...
if(isset($_POST['change'])){
  ...
  $select = mysqli_query($link, "SELECT * FROM enseignant WHERE id = '$id' AND email='$email' ");
  ...
  if($oldpass == $password){
    if($newpass == $repass){
          ...
          $update = mysqli_query($link, "UPDATE enseignant SET password = '$newpass' WHERE id = '$id' AND email='$email' ");
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="footer-pad">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="https://www.univ.dz">www.univ.dz/fsei</a></li>
              <li><a href="https://www.univ.dz">www.univ.dz</a></li>
