...
<div class="b-example-divider">
    ...
    <form  class="was-validated" action="contact_envoyer.php" method="post">
   ...
   <i class="fas fa-5x fa-envelope" style="color:#2c374c;"></i>
    </div>
    ...
    <div class="container">
        ...
        <textarea class="form-control" style="height: 200px" id="validationTextarea" name="message" placeholder="votre message ici " required ></textarea>





        <button class="btn btn-primary nvla" type="submit">Envoyer</button>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="footer-pad">
            ...
            <img class="logo-footer" src="logo_footer.png" alt="logo-footer" data-at2x="assets/img/logo.png" style="width:120px; margin-bottom: 45px; margin-left: 35px;">
