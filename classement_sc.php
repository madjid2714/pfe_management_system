...
<a href="affectation_sc.php"><button type="button" class="btn btn-success btn-md px-3" ><img src="pencil-square.svg"  title="editer l'tudiant" width="20" height="20" >   Lancer l'affectation
        </button></a>
...
<form  action="ajouter_classement_sc.php" method="POST" style="padding-left: 190px;">
 ...
 <!--      <th scope="col">SUJET AFFECTé</th>
  ...
  <tbody>
    <tr>
    <?php
      $select = mysqli_query($link, "SELECT * FROM etudiant where spécialité ='sc' ");
